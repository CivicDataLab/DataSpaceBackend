...
class MockResourceChartDetails:
    ...
    def __init__(self, chart_type="MULTILINE", title="Test Chart", description="Test Description", options=None):
...
class TestMultiLineChart(unittest.TestCase):
    ...
    def test_line_chart_creation(self):
        ...
        chart = MultiLineChart(chart_details, self.test_data)
    ...
    def test_time_based_data(self):
        ...
        self.assertTrue(all(period in x_axis_data for period in ['2023-01', '2023-02', '2023-03', '2023-04']))
    ...
    def test_value_aggregation(self):
        ...
        options = {
            'x_axis_column': self.x_field,
            'y_axis_column': [
                {'field': self.y_field1, 'label': 'Metric 1', 'aggregate_type': 'AVERAGE'}
            ]
        }
        chart_details = MockResourceChartDetails(options=options)
        chart = MultiLineChart(chart_details, test_data)
        result = chart.create_chart()
